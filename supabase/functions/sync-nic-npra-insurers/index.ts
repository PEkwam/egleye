...
const NIC_LIFE_INSURERS: InsurerInfo[] = [
  ...
  { insurer_id: 'emple-life', name: 'Emple Life Insurance Ghana LTD', short_name: 'Emple Life', category: 'life', website: 'https://www.emplelife.com.gh', keywords: ['emple life', 'emple'], brand_color: '#003399' },
