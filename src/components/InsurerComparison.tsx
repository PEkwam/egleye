    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] p-0 overflow-hidden">
        ...
        <div className="p-6 space-y-5 overflow-y-auto max-h-[calc(90vh-120px)]">
          {/* Advanced Quick Action Cards */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div 
              onClick={() => setActiveTab('overview')}
              className={`p-4 rounded-xl bg-gradient-to-br from-blue-500/10 via-blue-400/5 to-indigo-500/10 border-2 ${activeTab === 'overview' ? 'border-blue-500 shadow-lg shadow-blue-500/20' : 'border-blue-500/20 hover:border-blue-500/50'} transition-all cursor-pointer group hover:scale-[1.02] hover:shadow-md`}
            >
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <span className="text-sm font-bold text-blue-700 dark:text-blue-400">Market Analysis</span>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">Premium & asset comparison charts</p>
            ...
            <div 
              ...
              className={`p-4 rounded-xl bg-gradient-to-br from-emerald-500/10 via-emerald-400/5 to-green-500/10 border-2 ${activeTab === 'trends' ? 'border-emerald-500 shadow-lg shadow-emerald-500/20' : 'border-emerald-500/20 hover:border-emerald-500/50'} transition-all cursor-pointer group hover:scale-[1.02] hover:shadow-md`}
            >
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <span className="text-sm font-bold text-emerald-700 dark:text-emerald-400">Growth Trends</span>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">Quarter-over-quarter tracking</p>
              <div className="mt-3 flex items-center gap-1 text-xs text-emerald-600 dark:text-emerald-400 font-medium opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div 
              ...
              className={`p-4 rounded-xl bg-gradient-to-br from-amber-500/10 via-amber-400/5 to-orange-500/10 border-2 ${activeTab === 'rankings' ? 'border-amber-500 shadow-lg shadow-amber-500/20' : 'border-amber-500/20 hover:border-amber-500/50'} transition-all cursor-pointer group hover:scale-[1.02] hover:shadow-md`}
            >
              <div className="flex items-center gap-2.5 mb-2">
                <div className="p-2 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-lg shadow-amber-500/30 group-hover:shadow-amber-500/50 transition-shadow">
                  <Award className="h-4 w-4 text-white" />
                </div>
                <span className="text-sm font-bold text-amber-700 dark:text-amber-400">Rankings</span>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">Industry leaderboards & scores</p>
              <div className="mt-3 flex items-center gap-1 text-xs text-amber-600 dark:text-amber-400 font-medium opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div 
              ...
              className={`p-4 rounded-xl bg-gradient-to-br from-purple-500/10 via-purple-400/5 to-violet-500/10 border-2 ${activeTab === 'insights' ? 'border-purple-500 shadow-lg shadow-purple-500/20' : 'border-purple-500/20 hover:border-purple-500/50'} transition-all cursor-pointer group hover:scale-[1.02] hover:shadow-md`}
            >
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <span className="text-sm font-bold text-purple-700 dark:text-purple-400">AI Insights</span>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">Intelligent analysis & recommendations</p>
              <div className="mt-3 flex items-center gap-1 text-xs text-purple-600 dark:text-purple-400 font-medium opacity-0 group-hover:opacity-100 transition-opacity">
